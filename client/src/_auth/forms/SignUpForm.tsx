...
const SignUpForm = () => {
  ...
  return (
    ...
    <div className="sm:w-420 flex-center flex-col">
        ...
        <h2 className="h3-bold md:h2-bold pt-5 sm:pt-12 text-light-3 ">Create a new account</h2>
        <p className="text-light-3 small-medium md:base-regular mt-2">To use Metal-Brain, please enter your details</p>
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 w-full mt-4">
      ...
      <p className="text-small-regular text-light-3 text-center mt-2">Already have an account?
          <Link to="/sign-in" className="text-light-8 text-small-bold ml-1"> Log in</Link>
        </p>
    </form>
    </div>
  </Form>
